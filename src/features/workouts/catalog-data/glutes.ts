...
export const GLUTES_EXERCISES: Omit<Exercise, 'id'>[] = [
  ...
  },
  {
    ...
    targetMuscles: [
      ...
      { muscle: 'Adductors', role: 'secondary', activationScore: 0.4 },
      { muscle: 'Quadriceps', role: 'secondary', activationScore: 0.3 },
    ],
    repRangeLow: 8,
    repRangeHigh: 12,
    createdAt: Date.now(),
  ...
  },
  {
    ...
    targetMuscles: [
      ...
      { muscle: 'Hip Abductors', role: 'secondary', activationScore: 0.55 },
    ],
    repRangeLow: 12,
    repRangeHigh: 15,
    createdAt: Date.now(),
