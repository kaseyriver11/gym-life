...
const MUSCLE_NAME_TO_IDS: Record<string, string[] | null> = {
  ...
  'Forearm Extensors': ['forearm-extensors-left', 'forearm-extensors-right'],
  'Tibialis Anterior': ['tibialis-anterior-left', 'tibialis-anterior-right'],
  'Quadratus Lumborum': ['lower-back-ql-left', 'lower-back-ql-right'],
...
export const MUSCLE_PICKER_OPTIONS: { value: string; label: string }[] = [
  ...
  { value: 'Forearm Flexors', label: 'Forearms (Flexors)' },
  { value: 'Forearm Extensors', label: 'Forearms (Extensors)' },
  ...
  { value: 'Tibialis Anterior', label: 'Shins' },
...
const GROUP_FALLBACK_IDS: Partial<Record<string, string[]>> = {
  ...
  Biceps: ['biceps-left', 'biceps-right'],
  Triceps: ['triceps-long-left', 'triceps-long-right', 'triceps-lateral-left', 'triceps-lateral-right'],
  Forearms: ['forearm-flexors-left', 'forearm-flexors-right', 'forearm-extensors-left', 'forearm-extensors-right'],
  Legs: [
    'quads-left',
    'quads-right',
    'hamstrings-medial-left',
